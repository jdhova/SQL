...
-- PRINT EVEN NUMBERS 
	...
	select 0 as n 
	union all
	select n + 2 from RecursiveCTE where n < 20
	)

	SELECT * FROM RecursiveCTE 

	--QUESTION 2 PRINT FIZZ BUZZ AND FIBINACHI SEQUENCE WITH CTE RECUSSIONS AND WITHOUT WHILE LOOPS


	---- TOPICS PENDING  RECUSSION IN SQL, ADVANCED WINDOW_FUCTION NTILE ETC, STORED PROCEDURES, SELF JOIN , FUNCTIONS AND REGEX OPTIMIZE SQL
